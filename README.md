...
Originally created by [LiuYuancheng](https://github.com/LiuYuancheng/PLC_and_RTU_Simulator).  
This repository is a fork for educational/demo use by [Yashodeep](https://github.com/Yashodeep00).
